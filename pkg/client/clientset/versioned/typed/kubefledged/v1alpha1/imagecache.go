...
func (c *imageCaches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ImageCache, err error) {
...
func (c *imageCaches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageCacheList, err error) {
...
func (c *imageCaches) Create(ctx context.Context, imageCache *v1alpha1.ImageCache, opts v1.CreateOptions) (result *v1alpha1.ImageCache, err error) {
	result = &v1alpha1.ImageCache{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imagecaches").
...
func (c *imageCaches) Update(ctx context.Context, imageCache *v1alpha1.ImageCache, opts v1.UpdateOptions) (result *v1alpha1.ImageCache, err error) {
	result = &v1alpha1.ImageCache{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagecaches").
...
func (c *imageCaches) UpdateStatus(ctx context.Context, imageCache *v1alpha1.ImageCache, opts v1.UpdateOptions) (result *v1alpha1.ImageCache, err error) {
	result = &v1alpha1.ImageCache{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagecaches").
...
func (c *imageCaches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ImageCache, err error) {
	result = &v1alpha1.ImageCache{}
